...
(function () {
    ...
    var n = window, p = document, r = n.location, ea = function () {
    }, fa = /\[native code\]/, v = function (a, b, c) {
        return a[b] = a[b] || c
    }, ga = function (a) {
    ...
    var J = v(H, "perf", w()), Ha = v(J, "g", w()), Ia = v(J, "i", w());
    v(J, "r", []);
    w();
    w();
    ...
    var Ma = /^(\/[a-zA-Z0-9_\-]+)+$/, Na = /^[a-zA-Z0-9\-_\.,!]+$/, Oa = /^gapi\.loaded_[0-9]+$/, Pa = /^[a-zA-Z0-9,._-]+$/, Ta = function (a, b, c, d) {
            var e = a.split(";"), f = e.shift(), g = La[f], k = null;
    ...
    var Za = decodeURI("%73cript"), $a = function (a, b) {
        ...
        cb(a, c);
        var d = a ? a.split(":") : [], e = c.h || Ya(), f = v(H, "ah", w());
        if (f["::"] && d.length) {
        ...
        var k = v(Ga(c), "r", []).sort(), q = v(Ga(c), "L", []).sort(), u = [].concat(k), t = function (a, b) {
            if (m)return 0;
            n.clearTimeout(l);
            q.push.apply(q, x);
            var d = ((C || {}).config ||
        ...
        var x = $a(a, q);
        if (x.length) {
            var x = $a(a, k), F = v(H, "CP", []), G = F.length;
            F[G] = function (a) {
                if (!a)return 0;
                L("ml1", x, u);
                var b = function (b) {
    ...
    var P = function (a) {
        ...
        if (b)for (var c in b)b.hasOwnProperty(c) && (a[c] && b[c] && "object" === typeof a[c] && "object" === typeof b[c] && !gb(a[c]) && !gb(b[c]) ? R(a[c], b[c]) : b[c] && "object" === typeof b[c] ? (a[c] = gb(b[c]) ? [] : {}, R(a[c], b[c])) : a[c] = b[c])
    }, hb = function (a) {
        if (a && !/^\s+$/.test(a)) {
            for (; 0 ==
        ...
        var b = P("cu"), e = document.scripts || document.getElementsByTagName("script") || [], d = [],
            f = [];
        f.push.apply(f, P("us"));
    ...
    var qb = window.console, rb = function (a) {
        qb && qb.log && qb.log(a)
    };
    var sb = function () {
        return !!H.oa
    ...
    var wb;
    var xb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?\#]*)?\/u\/(\d)\//, yb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?\#]*)?\/b\/(\d{10,})\//, zb = function (a) {
    ...
    V.prototype.update = function (a, b) {
        if (null != a) {
            ...
            for (var c = b - this.g, d = 0, e = this.B, f = this.j; d < b;) {
                if (0 == f)for (; d <= c;)Bb(this, a, d), d += this.g;
    ...
    var Db = n.crypto, Eb = !1, Fb = 0, Gb = 0, Hb = 1, Ib = 0, Jb = "", Kb = function (a) {
        a = a || n.event;
    ...
    var Mb = function () {
        var a = Hb, a = a + parseInt(Jb.substr(0, 20), 16);
        Jb = Lb(Jb);
    ...
    var Sb = {
        ...
        vspace: "0",
        width: "100%"
    }, Tb = {allowtransparency: !0, onload: !0}, Ub = 0, Vb = function (a) {
        B(!a || wa.test(a), "Illegal url for new iframe - " + a)
    }, Wb = function (a, b, c, d, e) {
        Vb(c.src);
        var f, g = Pb(d, c), k = g ? Qb(d) : "";
        try {
    ...
    var Xb = /^:[\w]+$/, Yb = /:([a-zA-Z_]+):/g, Zb = function () {
        var a = zb() || "0", b = Ab(), c;
        c = zb(void 0) || a;
        var d = Ab(void 0), e = "";
        c && (e += "u/" + c + "/");
    ...
    }, gc = ec ? window.JSON.stringify : cc, hc = ec ? fc : dc;
    var ic = function (a) {
        var b;
    ...
    var kc = {se: "0"}, lc = {post: !0}, mc = {style: "position:absolute;top:-10000px;width:450px;margin:0px;border-style:none"}, nc = "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefresh".split(" "), oc = v(H, "WI", w()), pc = function (a, b, c) {
        var d, e;
        d = {};
        var f = e = a;
        ...
        f.exp = S(g + "exp");
        if (g = S(g + "location"))for (e = 0; e < g.length; e++) {
            var k = g[e];
            f[k] = n.location[k]
        }
        switch (a) {
        ...
        c._methods = m.join(",");
        return ua(d, f, c)
    }, qc = ["style", "data-gapiscan"], sc = function (a) {
    ...
    var Ac = function (a, b) {
        ...
        if (Bc(wc || {}))for (var t in c) {
            ...
            d = [];
            for (t in c)for (a = c[t], u = 0, b = a.length; u < b; u++)e = a[u], Dc(t, e, sc(e), d, b);
            Ec(q, d)
        }
    }, Fc = function (a) {
        var b = v(C, a, {});
    ...
    var Cc = function (a, b) {
        ...
        b && c ? (c(b), (c = b.iframeNode) && c.setAttribute("data-gapiattached", !0)) : C.load(a, function () {
            var c = Ea(a), e = b && b.iframeNode, f = b && b.userParams;
            ...
            case 1:
                ...
                if (b.parentNode) {
                    ...
                    if ((h || {}).allowPost && 2E3 < f.length) {
                        ...
                        m["data-postorigin"] = f;
                        f = Wb(b, c, m, e);
                        -1 != navigator.userAgent.indexOf("WebKit") && (k = f.contentWindow.document, k.open(), m = k.createElement("div"), q = {}, t = e + "_inner", q.name = t, q.src = "", q.style = "display:none", Wb(b, m, q, t, h));
    ...
    var Nc = /^\{h\:'/, Oc = /^!_/, Pc = "", Kc = function (a, b) {
        function c() {
            E("message", d, "remove", "de")
        }

        function d(d) {
            var f = d.data, k = d.origin;
            if (Qc(f, b)) {
                var h = e;
                e = !1;
                h && K("rqe");
                Rc(a, function () {
                    h && K("rqd");
                    c();
                    for (var a = v(H, "RPMQ", []), b = 0; b < a.length; b++)a[b]({data: f, origin: k})
                })
            }
        }
    ...
    var Sc = function (a, b) {
        ...
        this.P = c.path;
        this.$ = !!c.secure
    }, Tc = /^[-+/_=.:|%&a-zA-Z0-9@]*$/, Uc = /^[A-Z_][A-Z0-9_]{0,63}$/;
    ...
    var Xc = "https:" === window.location.protocol, Yc = Xc || "http:" === window.location.protocol ? Sc : Vc, Zc = function (a) {
    ...
    var ad = function (a) {
        ...
        d = "E" === c && e.c;
        return !d && ("U" !== c || e.c) || d && !Xc ? b : {N: !0, c: d, ca: a.substr(1), domain: e.domain, i: e.i}
    }, bd = function (a) {
        if (!a)return [];
        a = a.split("=");
        ...
        if (null !== a) {
            ...
            if (c) {
                var d = cd(c), e = d && d.ba[Number(a)], d = d && d.C;
    ...
    _c: {
        "jsl": {
            "ci": {
                "deviceType": "desktop",
                "oauth-flow": {
                    "authUrl": "https://accounts.google.com/o/z",
                ...
                "lexps": [81, 97, 100, 122, 123, 30, 79, 127],
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.cxJrt81f3y0.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCP9uZzP-g1-sWFxb1HLBFCjibACMA",
            "u": "https://apis.google.com/js/platform.js",
            "hee": true,
            "fp": "bf6c5b647f99b072ad26c36dd96c2a2ada06b6cc",
            "dpo": false
        },
